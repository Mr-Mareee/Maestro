...
WEB_SCANNER_AGENT_PROMPT=(
    ...
    "- Se trovi pagine con informazioni, controlla se ci sono credenziali, tecnologie particolari o altro CONTROLLANDO TUTTO IL FILE, NON fare tail,head o altro. analizzalo per bene"  
