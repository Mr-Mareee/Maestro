...
ORCHESTRATOR_PROMPT = (
    ...
    "Reconnaissance, PrivilegeEscalation, WebScanner o  FinalReporter.\n\n"
   ...
   # "- Se sono state trovate vulnerabilità sfruttabili → Exploitation.\n"
    "- Se hai credenziali di accesso alla macchina → PrivilegeEscalation.\n"
    "- Se hai letto il contenuto di una flag → FinalReporter.\n\n"
    "Rispondi SOLO con: Reconnaissance, WebScanner, PrivilegeEscalation o FinalReporter."
)
...
MEMORY_CLEANER_PROMPT = (
    ...
    "- mantieni i ragionamenti dei vari agenti come insight utili"
    ...
    "- Limitare il testo a 1/3 delle parole totali.\n"
...
RECON_AGENT_PROMPT = (
    ...
    "Ricordati di non eseguire comandi in locale ma sempre sulla macchina a distanza, ricordati di non usare comandi interattivi.\n\n"
    "Strategia tipica:\n"
    "- Usa sempre self_rag_tool per ottenere suggerimenti di comandi verificati.\n"
    ...
    "- Evita comandi lunghi come nmap -A o -p-.\n"
...
PRIVESC_AGENT_PROMPT = (
    ...
    "Ricordati di non eseguire comandi in locale ma sempre sulla macchina a distanza, ricordati di non usare comandi interattivi.\n\n"
    "FERMATI SE LEGGI IL CONTENUTO DI UNA FLAG, POI PRODUCI LA TUA FINAL ANSWER "
    "Il tuo compito è:\n"
...
WEB_SCANNER_AGENT_PROMPT=(
    ...
    "Il tuo compito è:\n"
<<<<<<< HEAD
    "- Analizzare il sito web target per identificare directory, pagine,e potenziali vulnerabilità.\n"
    "- Se trovi pagine con informazioni, controlla se ci sono credenziali, tecnologie particolari o altro cercando di ottenere tutte le credenziali possibili.\n"  
    "_ NON USARE SSH_TOOL, USA SOLO shell_tool, self_rag_tool e human_tool.\n"
    "- Usare self_rag_tool per ottenere suggerimenti di comandi per la scansione web ma genera prompt a parole chiave.\n"
=======
    "- Analizzare il sito web target per identificare potenziali vulnerabilità.\n"
    "- Se trovi pagine con informazioni, controlla se ci sono credenziali, tecnologie particolari o altro cercando di ottenere tutte le credenzili possibili.\n"  
    "- USA  shell_tool, self_rag_tool e human_tool.\n"
    "- usa human_tool quando ti senti fissato su un problema.\n"
